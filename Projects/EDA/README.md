...
1. [`01_top_demanded_skills.sql`](Projects/EDA/top_demanded_skills.sql) – demand analysis with multi-table joins  
2. [`02_top_paying_skills.sql`](Projects/EDA/top_paying_skill.sql) – salary analysis with aggregations  
3. [`03_optimal_skills.sql`](Projects/EDA/optimal_skills.sql) – combined demand/salary optimization query  
...
![Data Warehouse Schema](Diagrams/1_2_Data_Warehouse.png)
...
1. **[Top Demanded Skills](Projects/EDA/top_demanded_skills.sql)** – Identifies the 10 most in-demand skills for remote data engineer positions
2. **[Top Paying Skills](Projects/EDA/top_paying_skill.sql)** – Analyzes the 25 highest-paying skills with salary and demand metrics
3. **[Optimal Skills](Projects/EDA/optimal_skills.sql)** – Calculates an optimal score using natural log of demand combined with median salary to identify the most valuable skills to learn
